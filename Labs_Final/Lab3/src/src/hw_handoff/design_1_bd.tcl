...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set osc_output [ create_bd_port -dir O osc_output ]
  ...
  # Create instance: lab_0, and set properties
  set lab_0 [ create_bd_cell -type ip -vlnv rit.edu:user:lab:1.0 lab_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins lab3_axi_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net lab3_axi_0_duty [get_bd_pins lab3_axi_0/duty] [get_bd_pins lab_0/duty]
  connect_bd_net -net lab3_axi_0_enable [get_bd_pins lab3_axi_0/enable] [get_bd_pins lab_0/enable]
  connect_bd_net -net lab3_axi_0_period [get_bd_pins lab3_axi_0/period] [get_bd_pins lab_0/period]
  connect_bd_net -net lab_0_output [get_bd_ports osc_output] [get_bd_pins lab_0/output]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins lab3_axi_0/s00_axi_aclk] [get_bd_pins lab_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins lab3_axi_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins lab_0/reset] [get_bd_pins util_vector_logic_0/Res]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs lab3_axi_0/S00_AXI/S00_AXI_reg] SEG_lab3_axi_0_S00_AXI_reg
